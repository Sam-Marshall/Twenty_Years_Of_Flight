! function(t) {
    var i = {
        ...
        r = function() {
            function t(t) { this.x = t.x, this.y = t.y, this.maxRadius = t.radius, this.color = t.color, this.shadowBlur = 5, this.lineWidth = t.borderWidth, this.r = 0, this.factor = 2 / t.radius }
            return t.prototype.draw = function(t) {
                var s = .5
        ...
        o = function() {
            ...
            return t.prototype.drawArc = function(t, i, s, a, e) { t.save(), t.lineWidth = s, t.strokeStyle = i, t.shadowColor = this.strokeStyle, t.lineCap = "round", t.beginPath(), t.arc(this.centerX, this.centerY, this.radius, a, e, !1), t.stroke(), t.restore() }, t.prototype.draw = function(t) {
                var s = this.endAngle,
        ...
        n = function() {
            var i = function(t) { this.data = t.data, this.store = { arcs: [], markers: [], pulses: [], sparks: [] }, this.playAnimation = !0, this.started = !1, this.context = t.context, this.style = t.style, this.init() }
            return i.prototype.init = function() { this.updateData(this.data) }, i.prototype.add = function(t) {}, i.prototype.remove = function() {}, i.prototype.clear = function() { this.store = { arcs: [], markers: [], pulses: [], sparks: [] }, this.playAnimation = !0, this.started = !1, t.cancelAnimationFrame(this.requestAnimationId) }, i.prototype.updateData = function(t) {
                t && 0 !== t.length && (this.clear(), this.data = t, this.data && this.data.length > 0 && s.forEach(this.data, function(t) {
                    var i = new e({ startX: t.from[0], startY: t.from[1], endX: t.to[0], endY: t.to[1], labels: t.labels, label: this.style.arc.label, font: this.style.arc.font, width: this.style.arc.width, color: t.color }),
                        s = new a({ x: t.to[0], y: t.to[1], rotation: i.endAngle + Math.PI / 2, style: "arrow", color: t.color, size: 4, borderWidth: 0, borderColor: t.color }),
                        n = new r({ x: t.to[0], y: t.to[1], radius: this.style.pulse.radius, color: t.color, borderWidth: this.style.pulse.borderWidth }),
                        h = new o({ startX: t.from[0], startY: t.from[1], endX: t.to[0], endY: t.to[1], width: 15, color: t.color })
            ...
            }, i.prototype.play = function() { this.playAnimation = !0 }, i.prototype.pause = function() { this.playAnimation = !1 }, i
        }()
    L.MigrationLayer = L.Class.extend({
        options: { map: {}, data: {}, pulseRadius: 25, pulseBorderWidth: 3, arcWidth: 1, arcLabel: !0, arcLabelFont: "15px sans-serif", Marker: {}, Spark: {} },
        ...
        initialize: function(t) { this._setOptions(this, t), this._map = this.options.map || {}, this._data = this.options.data || {}, this._style = { pulse: { radius: this.options.pulseRadius, borderWidth: this.options.pulseBorderWidth }, arc: { width: this.options.arcWidth, label: this.options.arcLabel, font: this.options.arcLabelFont } } || {}, this._show = !0, this._init() },
        _init: function() {
            ...
            if (t.style.position = "absolute", t.style.width = this._map.getSize().x + "px", t.style.height = this._map.getSize().y + "px", this.container = t, this.canvas = document.createElement("canvas"), this.context = this.canvas.getContext("2d"), t.appendChild(this.canvas), this._map.getPanes().overlayPane.appendChild(t), !this.migration) {
                ...
                this.migration = new n({ data: i, context: this.context, style: this._style })
            }
        },
        _resize: function() {
        ...
        _convertData: function() {
            ...
            if (this._data && t) {
                var i = s.map(this._data, function(t) {
                    ...
                    return { from: [i.x, i.y], to: [s.x, s.y], labels: t.labels, value: t.value, color: t.color }
                }, this)
                return i
            }
        },
        _bindMapEvents: function() {
            var t = this
            this._map.on("moveend", function() { t.migration.play(), t._draw() }), this._map.on("zoomstart ", function() { t.container.style.display = "none" }), this._map.on("zoomend", function() { t._show && (t.container.style.display = "", t._draw()) })
        },
        _draw: function() {
            var t = this._map.getBounds()
        ...
        setData: function(t) { this._data = t, this._draw() },
        hide: function() { this.container.style.display = "none", this._show = !1 },
        show: function() { this.container.style.display = "", this._show = !0 },
        play: function() { this.migration.play() },
        pause: function() { this.migration.pause() },
        destroy: function() { this.migration.clear(), this.container.parentNode.removeChild(this.container), this._map.clearAllEventListeners(), this.mapHandles = [] }
    }), L.migrationLayer = function(t) { return new L.MigrationLayer(t) }
}(window)